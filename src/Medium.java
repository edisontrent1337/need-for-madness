...
public class Medium
{
    ...
    public void d(final Graphics graphics) {
        ...
        do {
            ...
            array2[array[0] = 0] = this.ys(ground, n2);
            if (array2[0] < 0) {
                array2[0] = 0;
            }
            array[1] = 0;
        ...
        do {
            ...
            if (this.zy != 0) {
                skyline = this.cy + (int)((this.skyline - this.cy) * this.cos(this.zy) - (this.fade[n7] - this.cz) * this.sin(this.zy));
                n8 = this.cz + (int)((this.skyline - this.cy) * this.sin(this.zy) + (this.fade[n7] - this.cz) * this.cos(this.zy));
            }
    ...
    public void aroundtrack(final CheckPoints checkPoints) {
        ...
        final int n2 = (int)Math.sqrt((double)((this.trz - this.z + this.cz) * (this.trz - this.z + this.cz) + (this.trx - this.x - this.cx) * (this.trx - this.x - this.cx)));
